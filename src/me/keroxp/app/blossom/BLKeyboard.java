...
public class BLKeyboard extends Keyboard {
  ...
  public BLKeyboard(Context context, int layoutTemplateResId, CharSequence characters, int columns,
  ...
  /**
   * KeyオブジェクトをXMLから生成するメソッド Resourceはres/xml/qwerty.xml
   * Xmlのparseとかは記法に則って書けば自動的にやってくれるらしい 記法はここ
   * http://developer.android.com/reference
   * /android/inputmethodservice/Keyboard.Key.htm
   **/
